...
export const BOOK_DECISION_PROMPT_VERSION = '2026-09-11-v4-decision-6' as const;
export const BOOK_COMPLETION_PROMPT_VERSION = '2026-09-11-v4-completion-2' as const;
